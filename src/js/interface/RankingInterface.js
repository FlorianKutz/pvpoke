		...
		function interfaceObject(){
			...
			function selectPokemon(e){
				...
				if(context != "custom"){
					...
					$details.find(".detail-section.float").eq(2).before($("<div class=\"multi-battle-link\"><p>Get all bulkpoints of <b>" + pokemon.speciesName + "</b></p><a target=\"_blank\" class=\"button\" onclick=\"getBulkPoints" + functionCall + "\">Get Bulkpoints</a></div>"));
				} else{
